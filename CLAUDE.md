...
- [ ] **Raise the password floor** — not plan-gated, and available now on the same Auth → Email page: minimum length (docs: under 8 is not recommended; default is 6) and required character classes. Worth doing before the first client regardless of the Pro decision above.
