...
export const SAMPLE_CANDIDATES: readonly SampleCandidate[] = [
  ...
  },
  {
    ...
    currentCompany: "Vendela Care Group",
    location: "Copenhagen",
    mandateId: "sample-larkspur",
    archetype: "Builder",
    tier: 2,
  ...
  },
  {
    ...
    currentCompany: "Ashfield Medical",
    location: "Dublin",
    mandateId: "sample-larkspur",
    archetype: "Operator",
    tier: 2,
  ...
  },
  {
    ...
    currentCompany: "Nyren Diagnostics",
    location: "Warsaw",
    mandateId: "sample-larkspur",
    archetype: "Builder",
    tier: 3,
  ...
  },
  {
    id: "sample-adeyemi",
    name: "Tolu Adeyemi",
    currentTitle: "Group Head of Digital",
    currentCompany: "Brackenmoor Health",
    location: "Manchester",
    mandateId: "sample-larkspur",
    archetype: null,
    tier: null,
